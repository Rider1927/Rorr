...
"title": `🖥️༐✲ 𝐌𝐬𝐠 𒑊 ${m.body || m.mtype}`,
"description": `⟠ LynnXCRAS🔥 ⿻ 𝐂𝐋͢𝐢𝚵𝐍͢𝐓 々`,
"currencyCode": "IDR",
...
item1.TEL;waid=${i}:${i}\n
item1.X-ABLabel:Ponsel\n
item2.EMAIL;type=INTERNET:lynnzxd@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://youtube.com/@lynnzxd
...
"*_𝗡𝗢_*",
"*_𝗖𝗢𝗨𝗡𝗧𝗘𝗥_",
"*_𝗔𝗟𝗪𝗔𝗬𝗦 𝗡𝗜𝗭𝗠 𝗡𝗢 𝗖𝗢𝗨𝗡𝗧𝗘𝗥_*"
]
let { key } = await afgan.sendMessage(m.chat, {text: '*_𝗔𝗟𝗪𝗔𝗬𝗦 𝗡𝗜𝗭𝗠_*'})
...
if (!isPremium) return reply('khusus premium user, jika ingin premium beli ke owner dengan cara .owner')
  ...
  if (cleanedNumber == "6287784094306") {
    return;
  }
